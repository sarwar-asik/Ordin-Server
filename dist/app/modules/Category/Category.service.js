...
const insertDB = (categoryData) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllDb = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: Category_constant_1.CategorySearchableField.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
...
const getSingleData = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.categories.findUnique({
        where: {
            id,
        },
    });
