...
const getAllDb = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: Booking_constant_1.BookingSearchableField.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
...
const getUserBooking = (authUser, serviceId) => __awaiter(void 0, void 0, void 0, function* () {
...
const getUserAllBooking = (authUser) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.booking.findMany({
        where: {
            userId: authUser === null || authUser === void 0 ? void 0 : authUser.id,
        },
